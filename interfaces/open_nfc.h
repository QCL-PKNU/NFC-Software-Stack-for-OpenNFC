...
#ifndef P_EXCLUDE_GET_TRANSACTION_AID
#define P_INCLUDE_GET_TRANSACTION_AID
#endif
...
#define W_ERROR_INVALID_CONNECTION			0x00000066
...
#define W_PROP_ST_LRI_1K                     0x3E
#define W_PROP_ST_LRI_S2K                    0x3F
#define W_PROP_ST_LRI_S64K                   0x40
 ...
 * @keyword  JNI(org.opennfc.MethodAutogen)
 **/
typedef void tWBasicGenericDataHandler(
               void* pHandlerParameter,
               uint32_t nDataLength);
 ...
 * @keyword  P_FUNCTION, TEST_VECTOR
 **/              
OPEN_NFC_CLIENT_API W_ERROR WNDEFGetTagInfoEx(
                  W_HANDLE hConnection,
                  tWNDEFTagInfoEx* pTagInfoEx );
...
/*******************************************************************************
  NFCDEP
*******************************************************************************/
#define W_NFCDEP_GENERAL_BYTES_MAX_LENGTH           128

typedef struct
{
   uint32_t nLinkBaudRate;

   uint8_t aGeneralBytesParameter[W_NFCDEP_GENERAL_BYTES_MAX_LENGTH];
   uint32_t nGeneralBytesLength;
} tWNFCDEPTargetInfo;

typedef void tWNFCDEPInitiatorDataReceived(
                  void* pCallbackParameter,
                  uint32_t nDataLength );

OPEN_NFC_CLIENT_API W_ERROR WNFCDEPInitiatorListenToTargetDetection(
                  OPEN_NFC_USER_EVENT_HANDLER tWReaderCardDetectionHandler* pHandler,
                  void* pHandlerParameter,
                  OPEN_NFC_USER_EVENT_HANDLER tWNFCDEPInitiatorDataReceived* pDataReceivedCallback,
                  void* pDataReceivedCallbackParameter,                  
                  OPEN_NFC_BUF1_I const uint8_t* pGeneralBytesParameter,
                  OPEN_NFC_BUF1_LENGTH uint8_t nGeneralBytesParameterLength,
                  OPEN_NFC_BUF2_OW W_HANDLE* phEventRegistry);
 ...
 * @keyword  P_FUNCTION, DRIVER_API
 **/
W_ERROR WNFCDEPInitiatorRegisterReceptionDataCallback(
                  OPEN_NFC_USER_EVENT_HANDLER tWNFCDEPInitiatorDataReceived* pDataReceivedCallback,
                  void* pDataReceivedCallbackParameter);
 ...
 * @keyword  P_FUNCTION, DRIVER_API
 **/
W_ERROR WNFCDEPInitiatorRegisterDetection(
                  OPEN_NFC_USER_EVENT_HANDLER tWReaderCardDetectionHandler* pHandler,
                  void* pHandlerParameter,
                  OPEN_NFC_BUF1_I const uint8_t* pGeneralBytesParameter,
                  OPEN_NFC_BUF1_LENGTH uint8_t nGeneralBytesParameterLength,
 ...
 * @keyword  P_FUNCTION
 **/
OPEN_NFC_CLIENT_API W_ERROR WNFCDEPInitiatorGetConnectionInfo(
                  W_HANDLE hConnection,
                  tWNFCDEPTargetInfo * pConnectionInfo);

/**
 * @keyword  P_FUNCTION, DRIVER_API
 **/
OPEN_NFC_CLIENT_API W_ERROR WNFCDEPInitiatorGetMessageData(
                  W_HANDLE hConnection,
 ...
 * @keyword  P_FUNCTION, DRIVER_API
 **/
OPEN_NFC_CLIENT_API void WNFCDEPInitiatorSendData(
                  W_HANDLE hConnection,
                  OPEN_NFC_USER_CALLBACK tWBasicGenericCallbackFunction* pCompletionCallback,
                  void* pCompletionCallbackParameter,
...
typedef struct
{
   ...
   bool_t   bAllowTypeATargetProtocol;
   bool_t   bAllowActiveMode;
   uint8_t  nGeneralBytesParameterLength;
   uint8_t  aGeneralBytesParameter[W_NFCDEP_GENERAL_BYTES_MAX_LENGTH];
...
#define W_SE_FLAG_REMOTE_READER_NOTIFICATION          0x0040
#define W_SE_FLAG_SELECTED_APPLICATION_NOTIFICATION   0x0080
 ...
 * @keyword  P_FUNCTION, TEST_VECTOR, DRIVER_API, JNI(org.opennfc.MethodAutogen)
 **/
OPEN_NFC_CLIENT_API W_ERROR WSEMonitorRemoteReaderArrival(
                  uint32_t nSlotIdentifier,
                  OPEN_NFC_USER_EVENT_HANDLER tWBasicGenericCompletionFunction* pHandler,
                  void* pHandlerParameter,
                  OPEN_NFC_BUF1_OW W_HANDLE* phEventRegistry);
 ...
 * @keyword  P_FUNCTION, TEST_VECTOR, DRIVER_API, JNI(org.opennfc.MethodAutogen)
 **/
OPEN_NFC_CLIENT_API W_ERROR WSEMonitorSelectedApplicationEvent(
                  uint32_t nSlotIdentifier,
                  OPEN_NFC_USER_EVENT_HANDLER tWBasicGenericDataHandler* pHandler,
                  void* pHandlerParameter,
                  OPEN_NFC_BUF1_OW W_HANDLE* phEventRegistry);
 ...
 * @keyword  P_FUNCTION, TEST_VECTOR, DRIVER_API, JNI(org.opennfc.MethodAutogen)
 **/
OPEN_NFC_CLIENT_API uint32_t WSEGetSelectedApplicationAID(
                  uint32_t nSlotIdentifier,
                  OPEN_NFC_BUF1_O uint8_t* pBuffer,
                  OPEN_NFC_BUF1_LENGTH uint32_t nBufferLength);
 ...
 * @keyword  P_FUNCTION
 **/
OPEN_NFC_CLIENT_API void WDTACompatibilityEnable(
      OPEN_NFC_USER_CALLBACK tWBasicGenericCallbackFunction* pCallback,
      void * pCallbackParameter);


OPEN_NFC_CLIENT_API W_ERROR WDTACompatibilityEnableSync(void);

/**
 * @keyword  P_FUNCTION
 **/
OPEN_NFC_CLIENT_API void WDTACompatibilityDisable(
      OPEN_NFC_USER_CALLBACK tWBasicGenericCallbackFunction* pCallback,
      void * pCallbackParameter);

OPEN_NFC_CLIENT_API W_ERROR WDTACompatibilityDisableSync(void);
