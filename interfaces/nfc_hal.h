...
#define NAL_SERVICE_READER_KOVIO    0x10  /* The reader service for Kovio RF Barcode ROM ID */
...
#define NAL_EVT_UICC_REMOTE_READER_ARRIVAL   (NAL_MESSAGE_TYPE_EVENT | 0x11)
#define NAL_EVT_UICC_SELECTED_APPLICATION    (NAL_MESSAGE_TYPE_EVENT | 0x12)
...
#define NAL_PROTOCOL_READER_KOVIO            0x0800  /* Reader Kovio RF Barcode ROM ID */
...
#define NAL_PROTOCOL_CARD_KOVIO              0x0800  /* Card Kovio RF Barcode ROM ID */
...
#define NAL_SE_DESCRIPTION_JUPITER  "SLE97-144SE"
#define NAL_SE_DESCRIPTION_GEMINI   "eSE VaultSEcure v1.0"
